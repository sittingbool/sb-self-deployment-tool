...
export declare function detectTypeInString(value: string | undefined): 'int' | 'float' | 'boolean' | 'null' | 'string' | string | undefined;
export declare function typeParsedValueFromString(value: string | undefined): number | boolean | string | null | undefined;
